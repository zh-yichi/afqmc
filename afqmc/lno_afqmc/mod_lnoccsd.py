...
# def lnomp2_solver(mcc, mo_coeff, uocc_loc, mo_occ, maskact):
#     # only support canonical orbitals now!!!
#     # spin_type = kind(mo_coeff)
#     if isinstance(mcc._scf, scf.rhf.RHF):
#         return rlnomp2_solver(mcc, mo_coeff, uocc_loc, mo_occ, maskact)
#     elif isinstance(mcc._scf, scf.uhf.UHF):
#         return ulnomp2_solver(mcc, mo_coeff, uocc_loc, mo_occ, maskact)
#     else: 
#         raise NotImplementedError('LNO Only Support Restricted and Unrestricted Now!')
...
#     # spin_type = kind(mo_coeff)
#     if isinstance(mcc._scf, scf.rhf.RHF):
#         return rlnoccsd_solver(mcc, mo_coeff, uocc_loc, mo_occ, maskact)
#     elif isinstance(mcc._scf, scf.uhf.UHF):
