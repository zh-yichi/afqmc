...
def energy(trial, walker, ham_data, wave_data):
    ...
    return slater_tools.rms_energy(wave_data["stocc"], walker, h0, h1, chol)
...
def rot_energy(trial, walker, ham_data, wave_data):
    ...
    return slater_tools.rms_rot_energy(wave_data["stocc"], walker, h0, rot_h1, rot_chol)
