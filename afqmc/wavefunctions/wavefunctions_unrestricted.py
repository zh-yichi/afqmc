...
class upt2ccsd(uhf):
    ...
    #     #     # e2_2
    #     #     gl_a_i = oe.contract("pr,rq->pq", green_a, chol_a_i, backend="jax")
    #     #     gl_b_i = oe.contract("pr,rq->pq", green_b, chol_b_i, backend="jax")
    #     #     lt2_green_a_i = oe.contract("pr,qr->pq", 
    #     #                                 chol_a_i, 
    #     #                                 8 * t2_green_a + 2 * t2_green_ab_a, 
    #     #                                 backend="jax")
    #     #     lt2_green_b_i = oe.contract("pr,qr->pq", 
    #     #                                 chol_b_i, 
    #     #                                 8 * t2_green_b + 2 * t2_green_ab_b, 
    #     #                                 backend="jax")
    #     #     carry[1] += (oe.contract("pq,pq->", gl_a_i, lt2_green_a_i, backend="jax")
    #     #                 + oe.contract("pq,pq->", gl_b_i, lt2_green_b_i, backend="jax")) / 2
    #     #     glgp_a_i = oe.contract("iq,qa->ia", 
    #     #                            gl_a_i[:nocc_a,:], 
    #     #                            greenp_a, 
    #     #                            backend="jax")
    #     #     glgp_b_i = oe.contract("iq,qa->ia", 
    #     #                            gl_b_i[:nocc_b,:], 
    #     #                            greenp_b, 
    #     #                            backend="jax")
...
class upt2ccsd_bar(upt2ccsd):
    ...
    def _calc_energy_pt(
        ...
        t1o = jnp.linalg.det(walker_up[:nocc_a,:]) \
            * jnp.linalg.det(walker_dn[:nocc_b,:]) / o0 # <bra|ket_bar>/<bra|ket>
        t2o = gt2g * t1o # <bra|T2|ket_bar>/<bra|ket>
        e012 = (e1_0 + e2_0) * t1o # <bra|h1+h2|ket_bar>/<bra|ket>
        t2e12 = (e1_2 + e2_2) * t1o # <bra|T2 (h1+h2)|ket_bar>/<bra|ket>

        return t1o, t2o, e012, t2e12
